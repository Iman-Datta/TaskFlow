        ...
        >
          <Link to="/" className="flex items-center gap-2.5 group select-none">
            ...
            <span className="text-[17px] font-bold tracking-tight leading-none">
              <span className="text-zinc-900 dark:text-zinc-100">Do</span>
          ...
          <div className="flex items-center gap-1.5">
            ...
            {!user && (
              <Link
                to="/auth"
                className="
                  relative h-[34px] px-3 flex items-center
                  text-[13px] font-medium
                  text-zinc-500 dark:text-zinc-400
                  hover:text-zinc-900 dark:hover:text-zinc-100
                  after:absolute after:left-1/2
                  after:-translate-x-1/2 after:bottom-0.5
            ...
            {user && (
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="
                    flex items-center gap-2 pl-1 pr-2
                    h-[34px] rounded-lg
                    hover:bg-zinc-100/80 dark:hover:bg-zinc-800/60
